...
#
#Functions for estimating Brier score, IPA, C-index and cumulative dynamic AUCt
#Using the versions available at https://github.com/survival-lumc/Validation_Under_Interventions, 
# from the paper of Keogh & van Geloven, DOI: 10.1097/EDE.0000000000001713
#################################################################################
#################################################################################
